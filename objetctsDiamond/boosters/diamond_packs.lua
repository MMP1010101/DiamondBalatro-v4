...
local create_diamond_card = function(self, card, i)
    ...
    -- Lista de cartas disponibles en tu mod (solo tienes caja_azul por ahora)
    local diamond_cards = {
        'j_od_caja_azul'  -- Tu joker actual con el prefijo correcto
    }
    
    -- Crear la carta específica del tipo Joker
    local card_key = diamond_cards[((i-1) % #diamond_cards) + 1]
    print("DEBUG: Creating card with key: " .. card_key) -- Debug print
    
    -- Crear carta del tipo Joker con la key específica
